...
/**
 * Represents the originating end of the {@link com.airbnb.spinaltap.common.pipe.Pipe}, where {@link
 * SourceEvent}s are received and transformed to {@link Mutation}s.
 */
