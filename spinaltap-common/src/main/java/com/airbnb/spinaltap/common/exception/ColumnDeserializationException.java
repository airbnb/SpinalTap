...
public class ColumnDeserializationException extends EntityDeserializationException {
  ...
  public ColumnDeserializationException(String columnName, String tableName, Throwable cause) {
